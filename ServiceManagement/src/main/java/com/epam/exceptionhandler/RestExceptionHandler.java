...
public class RestExceptionHandler {
	...
	public ExceptionResponse handleBatchException(ServiceStationException exception, WebRequest request) {
		log.error("RestExceptionHandler : handleServiceStationException");
	...
	public ExceptionResponse handleRuntimeException(RuntimeException exception, WebRequest request) {
		log.error("RestExceptionHandler : handleRuntimeException "+exception.getMessage());
		return new ExceptionResponse(new Date().toString(), HttpStatus.INTERNAL_SERVER_ERROR.toString(),
				exception.getMessage(), request.getDescription(false));
	}
}
