...
public class UserController {
	...
	@GetMapping("/marks")
	public ModelAndView marks(Integer quizNo, @RequestParam List<TreeSet<Integer>> answers) throws QuizNotFoundException {
		ModelAndView mv = new ModelAndView();
	...
	public ModelAndView addUser(String username, String password, String confirmpassword) throws DuplicateUserException {
		ModelAndView mv = new ModelAndView();
