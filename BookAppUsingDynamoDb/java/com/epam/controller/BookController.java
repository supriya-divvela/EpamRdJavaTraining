...
//
//	@GetMapping("/{bookId}")
//	public ResponseEntity<BookDto> getBook(@PathVariable("bookId") String bookId) throws BookException {
...
//
//	@PutMapping("/{bookId}")
//	public ResponseEntity<BookDto> updateBook(@PathVariable("bookId") String bookId, @RequestBody @Valid BookDto bookDto)
