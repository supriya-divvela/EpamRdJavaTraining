...
<html lang="en">
<head>
<title>Quiz Application - Update Question</title>
...
<body>
	...
	<div class="container my-4">
		<h2 class="text-center my-4">Update Question page</h2>
		<div class="row justify-content-center">
			<div class="col-md-8">
				<form action="/updatequestionwithdetails" method="post">
					<div class="form-group">
						<label for="qNo">Question Number:</label> <input type="text"
							class="form-control" id="qNo" name="qNo"
							value="${question.getQNo()}" required readonly>
					</div>
					<div class="form-group">
						<label for="title">Question Title:</label> <input type="text"
							class="form-control" id="title" name="title"
							value="${question.getTitle()}" required>
					</div>
					<div class="form-group">
						<label for="options">Options:</label> <input class="form-control"
							id="options" name="options" value="${options }" required>
					</div>
					<div class="form-group">
						<label for="difficulty">Difficulty:</label> <select
							class="form-control" id="difficulty" name="difficulty"
							value="${question.getDifficulty() }" required>
					...
					<div class="form-group">
						<label for="taggingTopic">Tagging Topic:</label> <input
							...
							value="${question.getTaggingTopic() }" required>
					</div>
					<div class="form-group">
						<label for="answers">Answers:</label> <input class="form-control"
							id="answers" name="answers" value="${answers}" required>
					</div>
					<div class="form-group">
						<label for="marks">Marks:</label> <input class="form-control"
							id="marks" name="marks" value="${question.getMarks() }" required>
					</div>
					<div class="form-group">
						<button class="btn btn-success ml-3">Update Question</button>
					</div>
				</form>
			</div>
		</div>
