...
//				.trainingType(trainer.getTrainingType()).duration(trainingDto.getTrainingDuration())
...
//		reportsClient.addTrainingSummary(TrainingSummaryDto.builder().trainerUsername(trainer.getUser().getUsername())
